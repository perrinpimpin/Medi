...
public class BD {
    ...
    public void ajouterMedecin(int ID_user, String nom, String prenom, String specialite, String service) {
        String sql = "insert into praticien(ID_user,nom,prenom,specialite,service) values (?,?,?,?,?)";
